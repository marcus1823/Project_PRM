...
public class PaymentFailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPaymentDate = findViewById(R.id.tvPaymentDate2);
        tvOrderId = findViewById(R.id.tvOrderId2);
        tvAmount = findViewById(R.id.tvAmount2);
        ...
        btnHomepage.setOnClickListener(v -> {
            Intent intentHome = new Intent(PaymentFailActivity.this, MainActivity.class);
